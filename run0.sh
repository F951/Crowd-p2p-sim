...
do	
	#for QUERIES in 3000 #QUERIES
	for QUERIES in {2000,3000} #QUERIES
	do	
		#for PEERS in 250 #PEERS
		for PEERS in {250,500,750,1000} #PEERS
		#for PEERS in {500,750,1000} #PEERS
		do		
			...
			do	
				...
				do
					...
					do			
						...
						#for UMBRAL_VOTACION in 90 #UMBRAL_VOTACION
						do		
