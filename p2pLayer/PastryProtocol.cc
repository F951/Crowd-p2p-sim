...
void PastryProtocol::inner_body(void)
{
    while(1)
    {
        ...
        while( !queue_in_lower.empty() )
        {
            ...
            //~ cout <<"Pastry: check queue in lower"<< endl;
        ...
        case PASTRY_SENDDIRECT:
        {
            ...
            //    cout << "Pastry: send direct destNodeID: " ;    fflush(stdout);
        ...
        case PASTRY_SENDDHT:
        {
            ...
            //cout << "route 2 " << BN_bn2hex(m->dest) << endl;  fflush(stdout);
        ...
        case PASTRY_RECEIVE:
        {
            ...
            // cout << "route3" << BN_bn2hex(m->dest) << endl;   fflush(stdout);
